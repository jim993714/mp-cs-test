...
import type { Coupon, GoodsDetail } from '@/pages/shop/components/goods-detail/types';

import type { CollectParam, GoodsCouponParams, GoodsDetailParams, ReceiveResult } from './types';
